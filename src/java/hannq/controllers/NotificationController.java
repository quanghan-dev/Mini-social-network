...
public class NotificationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Notification> listNoti = blo.getNotificationByMemberID(currentMember);
            if(listNoti != null){
                request.setAttribute("LIST_NOTIFICATION", listNoti);
                request.setAttribute("ADD_FORM", "NOTIFICATION");
                url = HOME;
            }
        } catch (Exception e) {
            log("ERROR at NotificationController: " +  e.getMessage());
        } finally {
